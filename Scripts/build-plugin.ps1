...
& $ccCmake --build $ccBuild --config $Configuration --target ChordCanvas_VST3 chordcanvas_install installer_api_probe payload_inspect core_tests audio_fidelity_tests log_tests theory_probe export_cache_tests package_version_tests payload_tests transaction_tests registry_tests participant_tests install_metadata_tests --parallel 3
