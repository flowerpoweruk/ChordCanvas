...
std::string narrow(const std::wstring& value){require(std::all_of(value.begin(),value.end(),[](auto c){return c>=32 && c<127;}),"Invalid ASCII installer field");return {value.begin(),value.end()};}
