...
Immutable local `dist/0.1.5/5579500498b3595c34d9be3e32808f0b61ec8eaf/`: **Setup.exe5,606,937bytes/SHA256a7739889742763aa169e534fd6e7cface958c9d3c67a0cc64fdbe286bcd6d9c6**; **Updater.exe5,606,941bytes/SHA2562ea9ed8abd2d7ac0cf2ae98a4cf2d8285060afcd17f17e7301a16ce86b129161**. Both AMD64/**NotSigned**/0.1.5/0.1.5.6; independent executable metadata/hashes and every payload hash verified. Existing0.1.3/0.1.4 immutable packages unchanged. This candidate supersedes0.1.4 for next installed retest; full release is unaccepted.

Actual own native GUI harness loads the copied packaged0.1.5 instrument, not source build output: editor attaches, Tempo unavailable/Play disabled; Settings and optional-switch refresh retain disabled Play, actual click yields **zero session.transport.play events**, revision0 remains empty. About displays0.1.5AGPLv3/exactly one current-version change. Settled capture rechecked after immediate UI refresh. Own window closed normally/**exit0**, native one editor.close/instance.destroy each. This is **I-layer/no audio/not Live acceptance**, not a full3/4/scaling/audio pass. Sanitized `engineering/meter-edit-evidence.json`; raw captures/private runtime logs ignored.

Actual read-only `build/verify-license-package-015.py` **PASS/exit0**: eight pinned upstream notice copies unchanged, eleven notice-manifest hashes exact, complete project AGPL/Inno texts and IJG acknowledgement preserved. Acquired Community18.10.12210.168/runtime/asset clearance already documented. Actual current native imports (Microsoft COFFDumper14.51.36257.0) **exit0/0**, Windows OS only/no separate VC/UCRT/debug runtime DLL. Public privacy scan **127trackedfiles/zero checked matches** and **five actual native logs/zero checked secret or personal-path matches**. Private logs/dumps/progressions/builds/dependencies/binaries remain excluded from Git. **REPO-05 PASS**, obsolete licensing blocker superseded in licensing ledger; no new licensing question. Catalogue **46 PASS/5 FAIL/95 NOT RUN/2 BLOCKED**, all148 expectations unchanged. Sanitized `engineering/licensing-package-evidence.json`.

Actual public hosted CI run35381775709/source4c6222ca completed **SUCCESS**; Server build is not Win11/Live acceptance. Latest source55795004 CI not rechecked. Ignored prepared `build/run-meter-015-updater.ps1` checks immutable hash and refuses while Live remains open; **NOT RUN**. Actual Live process still holds installed0.1.3 with owner manual work; safe closure pending, no force-close/discard. Continue actual update and installed Live0.1.5 meter/tempo/GUI/high-risk regression once safe host closure occurs. Full MIDI trailing/empty extent, deactivated host saving, complete scaling/audio/clipboard/package failures/offline/clean-machine and accepted stable publication remain open.


### Iteration 26 — consistent unavailable-clock Play state; scope and retained export review

Iteration 25 evidence committed/pushed as **7ad377a36913cb4aa297a9d25222b36f5873081c**, actual remote main matched. Additional source review found async UI refresh could enable Play using only Sync, until the next timer applied meter/known-tempo restrictions. Audio engine already refused invalid-meter/unknown-tempo playback. Correct **0.1.5/build6** applies consistent state during refresh and validates meter/known tempo inside activation callback. No audio-thread changes. Actual dirty `Scripts/build-plugin.ps1 -BuildDirectory build/plugin-shortcuts -VisualStudioLicenseConfirmed`: **exit0/13of13 PASS/47.71s**; official native validator **47PASS/0FAIL/exit0**, native processing **PASS/exit0**. Sanitized development receipt in `engineering/meter-edit-evidence.json`. Clean matching build/packages/installed host retest still NOT RUN. Immutable0.1.4 artifacts unchanged.

Read-only `build/verify-native-export-retention.py` **PASS/exit0**: actual installed0.1.3 native eight-bar103-byte and dense32-bar4250-byte exports remain readable/hash-exact after Live12.4.5 imported them, each filename chords.mid, valid session/export UUIDs, distinct private directories. Actual source documents retained; body moves and dedicated native export are distinct; code specifies copy. **MIDI-09 PASS**. Whole128-block export despite selection[1], no filename prompt and repeated UUID paths support MIDI-07 partially; concurrent GUI drags unrun, full scenario remains NOT RUN.

Original installed source revision178b6dcb copied to ignored review inputs; source widget/feature/Settings registration, processor minimal state and ignored incoming MIDI, package definitions and actual prior installed GUI/payload reviewed against all exclusions. **SCOPE-01/02/03 PASS** for installed0.1.3. No vocal/BPM/prediction/withdrawn widgets, forbidden timing/velocity/voicing controls, factory data/manual/standalone/background updater/telemetry/theme/automatic musical restoration. Legal notices permitted; binary recovery journal is not musical recovery. Sanitized `engineering/scope-and-export-evidence.json`. All148 unique IDs/legal statuses validated and every expected requirement remains byte-for-byte text-equivalent to committed catalogue. Catalogue **45 PASS/5 FAIL/95 NOT RUN/3 BLOCKED**; no broad UI/host/release pass inferred.

Ignored type1/type2 one-track experimental fixtures preserve the actual Type0 eight-bar export's event bytes exactly, PPQ960/EOT30720/9 balanced notes/no extra events; independent mido parse **PASS/exit0**. Actual host experiment NOT RUN; normal product still Type0 and no expected requirement changed. Owner safe Live closure remains pending; actual process still runs with unsaved manual work, no force-close/discard. Current hosted CI runs were in progress at read; not labeled successful. Next inspected commit/push, clean matching0.1.5 build and immutable executable packages, then actual safe update/current Live retest. Full trailing/empty clip extent, deactivated host saving, full GUI/scaling/audio/clipboard and package/offline/clean-machine/stable gates remain open.


### Iteration 25 — genuine clean committed 0.1.4 executables

Iteration 24 correction committed/pushed as **4c6222ca525e579d4bbf2268079b3233cc94f885**, actual remote main matches. Actual clean matching `Scripts/build-plugin.ps1 -BuildDirectory build/plugin-shortcuts -VisualStudioLicenseConfirmed`: **exit0/13of13 PASS/48.16s**, sourceDirty false. Product SHA256 **2d5f17312240ca47dab67d9a53b9a14decabb00124a821cf836bff04def9b7d8**, helper **c549ffc2a31084a4c20f4d90a15ba48bd46ff1d9a514a52cf57e586ecbffb833**. Official clean validator **47PASS/0FAIL/exit0**, native processing **PASS/exit0**. No tracked edits during build; matching provenance receipt verified.

Actual genuine `Scripts/package-windows.ps1` with clean matching bundle/helper/receipt, pinned compiler/licence, native payload inspector and established distribution authority: **exit0**. Independent executable hashes, AMD64 PE headers, 0.1.4/0.1.4.5 resources and complete **16-file payload** verified; native inspector **PASS/exit0**. Immutable local folder `dist/0.1.4/4c6222ca525e579d4bbf2268079b3233cc94f885/`: **Setup.exe 5,606,609 bytes/SHA256 5863253b154fb2ca15f1dbd0b3ad1653f580983b60ed29321f0c74b201d2548d**; **Updater.exe 5,606,613 bytes/SHA256 b19ea259888f93d77889bbce3f9b2a2b6b0b68d48d42c3d8b13dfbfac9d64248**. Both **NotSigned**. An initial private checker assumed15 entries and refused before writing; actual manifest/native inspector confirm16, corrected checker passes. Independent Python assertions cover every manifest payload/artifact hash, exact source and clean receipt. Sanitized evidence extends `engineering/meter-edit-evidence.json`; original installed0.1.3 failure/development results retained. Existing0.1.3 immutable artifacts untouched.

Live process still running with installed0.1.3 and additional owner manual edits; safe closure requested only after concrete corrected packages ready. Ignored prepared `build/run-meter-014-updater.ps1` verifies actual immutable artifact hash and refuses to launch while Live is open. It has **not run**. No force-close/discard or successful0.1.4 installation/host retest claimed. Official Ableton SMF/import references inspected again; no compatible trailing-silence clip-boundary method established; full-length/empty host export gate remains unresolved, no waiver presumed. Current catalogue **41 PASS/5 FAIL/99 NOT RUN/3 BLOCKED**. Full GUI/scaling/audio/clipboard, deactivated host saving, package failure/offline/clean-machine and accepted stable publication remain open. Continue independent checks while necessary owner safe closure is pending.

### Iteration 24 — exact overlap/group review; unsupported-meter timing correction

Iteration 23 committed/pushed as **04b79520e7510b3d9c294b12e5d9d0409b959667**, remote main matched. Actual installed0.1.3/Live12.4.5 overlap test: originals `[0,3840)`/`[3840,7680)` replaced by one C `[2880,6720)`, notes [60,64,67], no retained fragments/ripple. One Undo restores every original field. TL-06 PASS. Marquee selects [1,2]; body drag of selected C preserves group/spacing/music, moves both by3840; one Undo restores exact document. Full grid/boundary group scenario remains NOT RUN.

Actual host changed to **3/4**, native clock confirms numerator3/denominator4/120BPM/stopped. GUI reports **4/4 required**, Play disabled, but body drag changes progression revision30 to31. **AUD-21 FAIL** against acceptance timing-edit requirement. Correct **0.1.4/build5** blocks timing pointer operations and commits, pad append, length/history and keyboard timing changes while unsupported; disables timing controls, retains pad controls and defined MIDI export. Guard canceled mid-gesture; blocked recognized keys consumed within editor to avoid falling through to host. No host meter changed by product.

Actual native keyboard harness of installed0.1.3: Delete works, Ctrl+A/C do not reach expected actions. Experimental letter-case normalization dirty0.1.4 build: **exit0/13of13 PASS/48.24s**, but native Ctrl+A/C/Z remain inactive and **Ctrl+Delete deletes exactly like ordinary Delete**, indicating modifier delivery/routing limitations. Experimental code reverted; no alleged physical-keyboard fix/pass. Both own harness windows closed normally/exit0. Clipboard keyboard acceptance remains unrun.

Final meter correction command `Scripts/build-plugin.ps1 -BuildDirectory build/plugin-shortcuts -VisualStudioLicenseConfirmed`: **exit0/13of13 CTest PASS/42.71s**, dirty source04b79520. Official native validator **47PASS/0FAIL/exit0**; native processing **PASS/exit0**. Dirty plugin SHA256 **54e75bba390c2c401a0f6d1e182bf15a9616fb9ebd0311b97f2657d1e663beed**, helper **c549ffc2a31084a4c20f4d90a15ba48bd46ff1d9a514a52cf57e586ecbffb833**. Earlier meter-build test48/46 seconds and intermediate hashes are not substituted for these final inputs. Private runners/captures ignored; sanitized `engineering/meter-edit-evidence.json`. All148 exact IDs/statuses/evidence references validate; catalogue **41 PASS/5 FAIL/99 NOT RUN/3 BLOCKED**.

Live now contains additional manual edits/settings observed after detected local interaction; preserve its unsaved work. Attempts to restore our meter were rejected before input by the UI tool on detected local interaction. No force-close, discard or claim of restoration. Next commit inspected inputs, clean matching build and immutable genuine0.1.4 packages, then actual safe update/host meter retest. Full MIDI extent remains unresolved, host saving deactivated, full GUI/scaling/audio/package failure/offline/clean-machine and stable publication unpassed. Existing genuine0.1.3 executables remain available; no full completion claimed.

### Iteration 23 — actual installed 0.1.3 in Live 12.4.5; dense native export and playback

Iteration 22 evidence committed/pushed as **0fbe8d734e3c2bce1fabd407d8ff6f942f6800a3**, remote main matched. Live's own automatic update finished naturally; normal startup now runs **Live Suite 12.4.5**. Actual module inspection verifies the global installed VST3, not a development copy. Native header proves **0.1.3/build 4/source 178b6dcb087ff5203e858f1890ea5cef8f83d143**, correct host string resource version, 44,100 Hz/256 samples/stereo. Fresh instance defaults and empty eight bars verified. About shows 0.1.3, AGPLv3 and exactly five current release changes. E-minor repeat [64,67,71] reaches track/Main meters, survives editor hiding/reopening and stops when Repeat is switched off.

Actual native timeline interactions: double-click adds exactly one C; dragged Dm leaves a gap; C body move preserves duration and music. Both resize edges preserve the opposite edge and notes, including minimum-960-tick clamp. Exact specified C `[0,3840)` razor split produces `[0,1920)`/`[1920,3840)`; one Undo restores every original progression field. Append occurs after the latest block without filling the earlier gap. Source retains its three blocks after export/reopening; the destination's fresh instance is separate.

Actual native eight-bar export **103 bytes / SHA256 a9891ff9979f49b4e295b1086b0914c3d494ae273de15b7885087ceeb715ba2f** independently parsed with mido 1.3.3: nine exact balanced notes, Type 0/one track/960 PPQ, off-before-on, no padding/other events, EOT 30,720. Actual native drag into Live 12.4.5 still produces **End 5.1.1 / Length 4.0.0**, so ENV-04 remains **FAIL**. No waiver assumed.

Actual dense load: **32 bars / 128 minimum-duration seventh chords**. Shorten to 31 bars/124 blocks then Undo restores every original field. Last narrow Dm7 menu opens bounded anchored popover with all currently enabled controls; octave 4 to 3 changes only block 128, selection/cursor unchanged, normal Close works. One Undo restores all 128 blocks exactly. Actual dense native export **4,250 bytes / SHA256 e96a9c84ef0fd6095c2fa2ac82559732d3568a76a2f05a9827870f47001d8535**, independent explicit pitch fixtures confirm 512 ons/512 offs, balanced sorted off-before-on, EOT 122,880 and no other/out-of-range events. Actual Live import **Start 1.1.1 / End 33.1.1 / Length 32.0.0**. Built-in Analog on only the disposable destination track plays it with active track/Main meters. Actual position 1.1.2 at 18:20:26 UTC to 46.4.1 at 18:21:57 UTC, displayed loop count 1 to 2, proves playback beyond the first 64-second cycle at 120 BPM. Normal Stop observed 65.1.1/count 3. No owner work closed.

Ignored independent runners `build/verify-installed-013-midi.py`, `build/verify-installed-013-dense-midi.py`: actual exit 0/PASS. Ignored evidence writers `build/record-installed-live-013.py`, `build/record-installed-013-dense.py`, `build/record-dense-playback.py` completed; sanitized facts in `engineering/installed-live-013-evidence.json`. One scratch PowerShell parser error occurred before execution and was corrected. A ledger writer then failed on the Windows default character encoding; restored the unchanged published ledger bytes and reran with explicit UTF-8 successfully. UI tool text entry produced repeated digits and UIA set_value lacked a cached property; cleared Search normally and selected visible Analog. Root capture/window-position limitations are documented, not inferred product failures or fabricated DPI proof.

Additional installed review with **all three optional switches enabled**: selected last block 128 anchored editor shows every control on-screen. Sus2 yields **D7sus2 [74,76,81,84]**, then Sus4 **D7sus4 [74,79,81,84]**, truthful immediate labels/exclusive suspension; only associated block changes, selection [128] retained, all 127 others unchanged. Two Undo restore the original dense progression exactly; normal Close works. Actual private snapshot comparisons PASS.

Catalogue **40 PASS / 4 FAIL / 101 NOT RUN / 3 BLOCKED**, all 148 unique exact IDs/legal statuses/evidence references validated. Current installed source remains immutable 178b6dcb; these are evidence-only changes. Actual saving/exporting remains deactivated. Full trailing/empty clip extent, full Windows scaling and gesture/audio/lifecycle coverage, clean-machine/network-disabled execution, remaining genuine package failure modes and accepted stable publication remain open. Continue independent acceptance; no full release claimed.

### Iteration 22 — genuine closed-host recovery, update, uninstall and reinstall

Owner confirmed Live closed; main Ableton Live process absent (ordinary Swapper/audio-control helpers left alone). Hash-checked genuine **0.1.3 Updater exit 0**; actual runtime log reports installation succeeded/no restart. Production recovery removed the retained prior committed journal/previous bundle; no manual purge. Installed **all 16 payload hashes and helper match**, numeric version **0.1.3.4**, one fixed uninstall identity/version 0.1.3. Saved synthetic progression and **all five native log names/hashes unchanged**. Installed official validator **47 PASS / 0 FAIL / exit 0**, native processing **PASS / exit 0**.

Actual same-version genuine Updater **exit 7**, explicit **already up to date**, every measured file preserved. Registered genuine ordinary uninstaller **exit 0**: owned VST3 bundle/application directory/uninstall entry absent, saved progression and all five logs preserved. Actual genuine Updater with no installation **exit 7**, explicitly requires Setup; no fresh installation created. Genuine **Setup reinstall exit 0**, exact plugin hash/one entry, preserved saved file/logs. Other vendors: **two files, names and SHA256 unchanged** across the update/uninstall/reinstall sequence. Actual older **0.1.2 Updater exit 7**, explicit newer-installed/downgrade refusal, files preserved. Reinstalled validator **47 PASS / 0 FAIL / exit 0**. Exit 7 is the actual Inno PrepareToInstall refusal result, including the non-destructive already-current outcome; not mislabeled installation success. Manual Windows consent only.

Commands are ignored runtime runners `build/run-closed-live-updater.ps1`, `build/run-same-version-updater.ps1`, `build/run-ordinary-uninstall.ps1`, `build/run-absent-install-updater.ps1`, `build/run-fresh-reinstall-setup.ps1`, `build/run-downgrade-updater.ps1`; actual binary validator/probe against the global installation. Private runtime logs/results/baselines remain ignored. Sanitized evidence: `engineering/installed-013-evidence.json`. Original mapped-host refusal evidence remains intact. Actual reinstalled native payload inspector and installer API probe **PASS / exit 0**; stable component/controller IDs match the older bundle. Both executable PE headers AMD64; actual installed DLL import inspection (Microsoft COFF Dumper 14.51.36257.0) exits 0/0, Windows OS dependencies only. REL-04 and REL-10 now PASS; catalogue **28 PASS / 5 FAIL / 112 NOT RUN / 3 BLOCKED**. Host executable now reports 12.4.5; the automatic host update remains in progress.

Actual Live relaunch currently displays **its own automatic update in progress** and refuses startup. Normal OK dismissed the notice; no interruption of the host updater. Latest installed Live/audio/current About acceptance awaits actual startup. Network-disabled/clean-machine execution, complete package failure modes, complete GUI/DPI/lifecycle tests, full trailing/empty clip extent, deactivated host saving and stable publication remain unpassed; no full acceptance claimed.

### Iteration 21 — clean committed 0.1.3 genuine executable packages

Evidence iteration 21 committed/pushed as **7e74100e2fde979307f8d2893662c9a34747200c**, actual remote main matched. Both immutable executable hashes rechecked against manifest. Actual safe teardown: hid only our editor and deleted only the selected disposable Track 3 device; Track 3 is now empty MIDI, existing Track 1/2 remain and Live is still stopped/open with its unsaved Set. No force-close. Licensing authority remains settled; remaining barriers are actual host closure, host import/saving behaviour and unfinished acceptance, not a new licensing request.

Iteration 20 committed/pushed as **178b6dcb087ff5203e858f1890ea5cef8f83d143**, actual remote main matched. Clean matching **0.1.3 / build 4** command `Scripts/build-plugin.ps1 -BuildDirectory build/plugin-reviewed -VisualStudioLicenseConfirmed`: **exit 0 / 13 of 13 CTest PASS / 46.98 s**, sourceDirty false. Actual clean product SHA256 **fd8bbd452eba3c0c25401effc65e6cfc2a73f20836643ae28448ec40ce7111c4**; helper **e200323f6d8962aaf710c38bb4b7eb8510843b045fd77b451ccaf2fd66f6069f**. Clean official Steinberg validator **47 PASS / 0 FAIL / exit 0**, native processing **PASS / exit 0**. Actual hosted CI run **35375720639 completed SUCCESS**, source 178b6dcb087ff5203e858f1890ea5cef8f83d143; Server runner is not Live acceptance.

Actual `Scripts/package-windows.ps1` with matching clean receipt/native bundle/helper, pinned compiler/licence, payload inspector and established distribution rights: **exit 0 / 16-file complete AMD64 owned payload validation PASS**. Genuine immutable **Setup.exe 5,606,804 bytes / SHA256 67e0e8a689abe90f05a5ff3a0641556f74179d46107354b0c2e5d62763300a64** and self-contained **Updater.exe 5,606,808 bytes / SHA256 ebb450ac91b18fb58ec9777f07421f8ac5f67fed37a60e0f00dff4d12bc84daa**, both **NotSigned**. Numeric version 0.1.3.4; source/changelog/receipt/package hashes match. Actual ignored local output: `dist/0.1.3/178b6dcb087ff5203e858f1890ea5cef8f83d143/`, with SHA256SUMS.txt/manifest. These are genuine product executable candidates; no successful latest installation/stable release inferred. Sanitized facts: `engineering/gui-package-evidence.json`.

Live invalid-load review: actual corrupt synthetic file refused with concise popup and operation.error, **revision 4 and every prior progression field unchanged**. Available UI target selection initially omitted the modal; root activation/keyboard did not dismiss it. Fresh list_apps exposed a separately targetable ChordCanvas error window; normal Return on that selected window dismissed it. This is recorded as tool targeting behaviour, not an invented product failure. Completed all six actual corrupt/oversized/schema/invalid-voicing/overlap/out-of-range loads. Each error was shown and dismissed; each actual following snapshot remains revision 4 and exactly the three prior blocks. STATE-07 PASS for cached installed 0.1.0, latest host retest unrun. Catalogue now **26 PASS / 5 FAIL / 114 NOT RUN / 3 BLOCKED**. Structured result validation confirms all 148 exact unique scenario IDs, legal statuses and existing evidence references. First checker incorrectly treated ENV-07 two combined references as a single filename and failed; corrected reference parsing PASS. Six owned fixtures and private logs remain ignored.


Actual genuine **0.1.3 Setup and Updater each exit 7**, native PrepareToInstall specifically requests save/close Live. Both runs preserve installed 0.1.1 DLL hash, saved synthetic progression and **all five** actual diagnostic log hashes, measured using active-writer-compatible FileShare.ReadWrite before/after. No automated UAC consent, force-close or retained-state deletion. Successful latest update/reload is still unrun, because Live remains open.

Owner safe Live closure remains pending; open unsaved mapped host is not force-closed. Full trailing/empty MIDI clip extent, deactivated host saving, complete installed GUI/DPI/audio/gesture acceptance, successful corrected update/recovery/reload, fresh/uninstall/offline/clean-machine and stable publication remain open. **Real latest executable files are delivered locally; full accepted release remains unfinished.**

### Iteration 20 — dense/native GUI defects corrected; actual Live manual state tests

Iteration 19 committed/pushed as **e68b5f8a59bec3051e7159d1a0932ed1b9a24a78**; actual hosted run **35373821766 completed SUCCESS**, same source (Server runner is not Live acceptance). Re-read full GUI specification and acceptance catalogue. Native review of **32 bars / 128 minimum-duration seventh chords** exposed menu-dot/label spill outside tiny blocks. Clip block painting, measured compact-root fallback and narrow menu indicator correct it. Selected-block editor now names the actual chord. Hover distinguishes body/resize edges. Real final Dm7 anchored popover remained on-screen at the optional-control minimum size; native Save plus exact comparison proves **only block 128 octave changed 3 to 4**, all other stored fields unchanged. Undo reviewed. Native maximize exposed stale Fit scale; Canvas resize now refits. Actual enlarge and restore both display the full eight bars. Popover seventh toggle visibly updates title C → Cmaj7 immediately. These are actual native harness interactions, **not U-layer Live 0.1.3 acceptance**.

Actual installed/cached **0.1.0 / source 6ba737c53deb257bdb07bd97878f4e4ea0388f76** in **Live 12.4.3**: native Save exact C/G with leading/trailing rests; remove/recreate only disposable device → empty defaults; explicit Load → exact original semantic fields/timing/length and resolved C [60,64,67], G [67,71,74]. Filesystem currently contains 0.1.1, but actual Live diagnostic header proves it still runs cached 0.1.0; no false 0.1.1/latest host pass. STATE-05 PASS. Change current key/sound to F Minor/Guitar, append B-flat minor, Load original C/G, then one Undo: all three prior blocks restored exactly, F Minor/Guitar retained, revisions 2→3→4. STATE-06 PASS for that running image. Sanitized evidence: `engineering/live-manual-state-evidence.json`.

Actual Live executable string ProductVersion is **12.4.3** whereas generic fixed ProductVersion is **1.0.0.1**. Diagnostics now prefer bounded numeric string ProductVersion/FileVersion with truthful resource source, falling back to fixed version/unavailable; host path is never logged. Regression uses a real synthetic PE version resource reproducing this mismatch. Actual dirty **0.1.3/build 4** command `Scripts/build-plugin.ps1 -BuildDirectory build/plugin-reviewed -VisualStudioLicenseConfirmed`: **exit 0 / 13 of 13 CTest PASS / 48.19 s**, diagnostics regression PASS. Official validator **47 PASS / 0 FAIL / exit 0**. First processing invocation supplied bundle directory instead of required module file and correctly refused exit 1; corrected module invocation **PASS / exit 0**, lifecycle/rates/fresh silence verified. Raw outputs remain ignored. Dirty product SHA256 **1de894567c42eddeb624c5a77fe17bfbf09f61cf43cd9d4712fb57cb04e461e3**.

Next: commit inspected/tested inputs; clean matching build and genuine immutable 0.1.3 Setup/Updater. Owner safe Live closure is still pending; current open unsaved Set will not be force-closed. Corrected successful recovery/update/reload, complete Live GUI/DPI/sound/gesture acceptance, clean-machine/offline/uninstall, deactivated host save/reopen, full trailing/empty MIDI extent and accepted stable release gates remain open. Real existing candidates are available; completion is not assumed.
### Iteration 19 — corrected genuine packages; actual safe loaded-image refusals

Iteration 18 committed/pushed as **eedbc498767fbf5c0e893bd7ea471e2f026a61cd**; actual remote main matched. Clean committed **0.1.2/build 3** native build **exit 0 / 13 of 13 CTest PASS / 46.36 s**, sourceDirty false. Plugin SHA256 **6c4a71ae0e2117b087dc7c9e8143d5141abab14af44e1c72f25a1ebe5a564b89**; helper **b8068beb4aac095af184f8875a033a9b8c0929aa559b969587e9b70978e26fae**. Official validator **47/0/exit 0**, native processing **PASS/exit 0**. Genuine immutable 0.1.2 Setup/Updater package compilation **exit 0**, complete 16-file AMD64 payload validation PASS. Setup **5,606,435 bytes / SHA256 16ec03625295bc8b830f79a79c2c5469b05022cfef809c6fc49b8c6de5f116c3**; Updater **5,606,439 bytes / SHA256 0f24224f559cac16abb0fa4b05a719e5b59a7a27178c5d45c2de6d1285c63297**; both unsigned.

After actual manual Windows UAC approval, **both corrected genuine packaged executables exit 7 with the specific save/close Live message** while unsaved Live retains the old installed image. Installed 0.1.1 DLL hash unchanged. Setup refusal: all **five** native diagnostic log hashes unchanged with a reader sharing mode compatible with active writers. Updater refusal: saved synthetic progression hash unchanged. Its first Get-FileHash attempt could not read two active logs; null comparisons corrected to NOT RUN, no active-log pass inferred. REL-06 now PASS for this actual retained mapped-image scenario; ENV-06/successful corrected upgrade/reload remain open. No owner host closure or manual retained-state deletion.

Source colour-role calculations: minimum ordinary-text ratio **5.1625:1**, essential-boundary/degree-strip ratio **3.0461:1**, sampled roles meet engineering targets. Reproducible `Scripts/verify-contrast.py`; first scratch parser used eight digits after 0xff instead of six and failed KeyError, corrected actual computation PASS. Ideal alpha composites/quantization/full rendered-state review limitations recorded; **not** formal certification or full UX-11 acceptance. Evidence: `engineering/corrected-package-evidence.json`, `engineering/contrast-evidence.json`.

Next: continue native interaction review independently; on owner-safe Live closure execute corrected recovery/update, inspect actual new version/identity/changelog/audio/GUI, preserve user files, and continue uninstall/fresh-install/offline/clean-machine/host acceptance. Full Live trailing/empty clip extent decision still pending; saving/exporting disabled. **Corrected real Setup.exe/Updater.exe exist and refuse loaded images safely; full accepted release is unfinished.**

### Iteration 18 — actual loaded-image updater defect; corrected native checks

Iteration 17 committed/pushed as **a8306846347cda4094845ad34a42afa4cc06aae3**; actual remote main matched. Clean **0.1.1/build 2** native build **exit 0 / 13 of 13 CTest PASS / 47.24 s**, sourceDirty false; plugin SHA256 **4069c8160da7fcd7d1558710b08e76ced063784b2534b956368aadcf852733b7**. Official validator **47/0/exit 0**, native processing **PASS/exit 0**. Genuine Setup **5,605,881 bytes / SHA256 5a932bd75ad3e92333fa8a858174a10472a3d2f5cc9a47f2dd6a9a075c18fb3e** and Updater **5,605,885 bytes / SHA256 7feddf69537f8a54a3d3562b78757140dd082f14938d4894b874a4f8afb61930** compiled; both unsigned. Actual source 6ba737c and 84fc3a4 hosted workflows completed success; no hosted Live evidence inferred.

**Blocking real-package failure:** after manual Windows UAC approval, genuine newer Updater **exit 0** installed complete 0.1.1/one fixed registration while **Live still mapped the installed old image**. This should have refused. One committed journal and one previous bundle remain (two old files); loaded image prevented final cleanup. No manual removal or forced owner closure. New installed bytes themselves validate **47/0/exit 0**, native processing **PASS/exit 0**, but **0.1.1 package is not accepted**. ENV-06/REL-06 recorded FAIL.

Root cause: READ/DELETE-only availability probes miss an executable image section after ordinary file handles close. Microsoft primary executable-image documentation confirms WRITE_DATA conflict checks. Corrected update/recovery, metadata and uninstall probes to request **GENERIC_WRITE** too, without writing bytes. Actual real SEC_IMAGE regression: old probe succeeds, corrected update refuses without mutation; late image mapping after staging is caught by the second pre-rename check and staging rolls back. Five focused CTest scenarios **5/5 PASS / 38.64 s**, followed by final transaction executable **PASS**. Attempted holding handles across directory rename actually failed (exit 1); removed that approach. Diagnostic test exception reporting improved. No atomic held-handle protection claimed.

Expanded independent music21 **10.5.0** / mido **1.3.3** oracle: **30,870 actual serialized MIDI chords PASS**, exact pitches/velocities/offs/channel/rests/full file endpoint plus existing labels/42 scales. Session invariance **840 key/sound/rate combinations plus active pad/block previews PASS**. First test compile used absent volumeDb member (C2039); corrected to existing gain, recompile/test PASS. MIDI-06 acceptance PASS. Actual installed 0.1.0 Live clock review: available 120 BPM, 44.1 kHz/256 frames/4/4, later Live start around bar 13 produces local tick 0 twice; host stops freeze 23004/24074. ENV-05 PASS; no separate pause event inferred. Five actual private local diagnostic logs audited: zero secret/personal-path pattern matches; source and public Git reviewed, only workflow token expression matched. LOG-11/REPO-02 PASS; private logs are not published.

Prepare corrected **0.1.2/build 3** inputs, clean matching build and immutable genuine packages. Removing only the disposable Track 3 device does **not** unload Live's mapped DLL. Owner's unsaved Set remains; minimum manual safe Live closure requested for real recovery/update/reload, not forced. Full trailing/empty clip extent decision still pending; deactivated host saving, complete GUI/DPI/dense gestures, offline/clean-machine/uninstall and stable-release gates open. Evidence: `engineering/image-section-evidence.json`, `engineering/repository-audit-evidence.json`. **Real executables exist, but full accepted delivery remains unfinished.**

### Iteration 17 — genuine installed VST3 in Live; keyboard and newer updater inputs

Iteration 16 committed/pushed as **84fc3a43da10024131a4749f7c88774830138567**; remote main matched. Genuine **0.1.0 Setup actually completed exit 0**, native log reports installation succeeded/no restart. Complete global installed payload **16 files PASS**; plugin/helper hashes match the genuine package. Single fixed HKLM64 uninstall identity/version 0.1.0. Installed official validator **47 PASS / 0 FAIL / exit 0**; installed native processing **PASS / exit 0**. Actual **Live 12.4.3** system-folder scan/load succeeds; readonly process module inspection verifies the installed VST3 is actually loaded. Fresh defaults visible, double-click adds exactly one C block. Repeating D-minor audition reaches track/Main meters, persists when the editor is hidden and stops with Repeat off. Owner's unsaved Live work was not closed. This does not establish complete installed acceptance.

Genuine same-version Updater bootstrap **exit 2**, no runtime log created, installed plugin hash unchanged. It ended before elevated runtime acceptance; **not** an already-up-to-date pass. No automated UAC consent. Prepare a genuine newer payload for actual upgrade testing instead of claiming this launch succeeded.

Development version **0.1.1 / build 2**: enabled keyboard traversal of voicing/reset/transport/editing buttons and added an inset focus ring distinct from selected state. Actual native development view: selected octave 3 focus ring visible; Tab visibly reaches octave 4; Return activates it. Pinned JUCE buttons use Return; Space did not activate it. This is a native harness review, not a Live keyboard acceptance pass. Full dirty native build **exit 0 / 13 of 13 CTest PASS / 48.02 s** before the small inset-ring follow-up; actual follow-up VST3 rebuild, validator **47/0/exit 0** and processing probe **PASS/exit 0**. Build-identity definitions now apply only to consuming sources, avoiding needless recompilation of all JUCE modules on every source commit.

First MSVC `audio_probe` compile exposed the Windows max macro; explicit NOMINMAX corrected it, actual rebuild **exit 0**. Actual **72 MSVC offline engine measurements: signal/allocation checks PASS**; exact maximum average/deadline fractions recorded in `engineering/keyboard-review-evidence.json`. One measured call exceeded its buffer deadline; no Live performance/listening pass inferred. Native Load dialog was cancelled without progression changes after the available UI tool could not enter its filename and refused set_value due an uncached property. Manual progression UI tests remain **NOT RUN**, not a product failure inferred from tool behaviour.

Sanitized installed/package and acceptance evidence updated. Full-span trailing/empty MIDI remains **FAIL** in Live despite correct files; explicitly requested owner decision on retaining that release requirement versus documenting the host limitation is pending. Disabled Live saving, comprehensive GUI/DPI/dense gestures, actual newer updater, clean-machine/offline and stable release gates remain open. Next: commit inspected tested inputs, clean matching 0.1.1 build/package, actual safe upgrade and remaining acceptance. **Real Setup.exe/Updater.exe exist; complete accepted product/stable release is not claimed.**

### Iteration 16 — genuine product executables actually compiled

Iteration 15 committed/pushed as **6ba737c53deb257bdb07bd97878f4e4ea0388f76**; remote main actually matched. Clean committed Release build **exit 0 / 13 of 13 CTest PASS / 48.11 s**, receipt sourceDirty false. Native product SHA256 **54305aaddf3a022f2b2ee36dda97bdb887d9c3e178791797e2e64a430b4d1230**. Official Steinberg validator **47 PASS / 0 FAIL / exit 0** and isolated native processing probe **PASS / exit 0** on that binary. Hosted workflow **35370004042 / source 6717f55... / job 105681468728** actually completed success; hosted Server 2025 is not Win11/Live acceptance.

Positive `Scripts/package-windows.ps1` execution with matching clean native bundle/helper/receipt, pinned Inno licence/compiler, native payload inspector and established distribution rights: **exit 0 / 16-file owned AMD64 payload validation PASS**, both genuine product executables compiled. Version **0.1.0 / numeric 0.1.0.1**. Setup: **5,605,902 bytes**, SHA256 **81a6da0009561bbf9067d071d073d235cc15d6add106a6222ea4a48c4d953402**. Updater: **5,605,906 bytes**, SHA256 **b3f2c6d2e5fd9f302cfcea4f5113c9be8bfe044ca6c70c918ffbbd6ce6068149**. Both **NotSigned**. Actual ignored output: `dist/0.1.0/6ba737c53deb257bdb07bd97878f4e4ea0388f76/`, with manifest/checksums. These contain the real product VST3, unlike the prior synthetic fixture. Actual PE inspection: Windows OS imports only, no separate VC runtime DLL prerequisite. Clean-machine execution unrun.

Hash-checked actual Setup launched with `/VERYSILENT /SUPPRESSMSGBOXES /NORESTART` and private log; no owner application closure. Actual Windows consent process pending owner UAC approval; no installation success or exit invented. Continue global installation verification, installed Live/GUI, actual offline updater/uninstall and remaining acceptance. Full trailing-rest/empty MIDI import, disabled host saving, GUI/DPI and clean-machine gates remain open. No stable release or complete acceptance claimed. Sanitized facts: `engineering/product-package-evidence.json`. Initial evidence-write command had a PowerShell syntax error before execution; corrected with a structured patch.
